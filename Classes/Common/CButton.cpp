...
void CButton::setButtonInfo(const char *normalImg, const char *touchedImg, Layer &parent, const cocos2d::Point locPt)
{
	...
	parent.addChild(_normalPic,1);  // 加入目前的 Layer 中 1: Z 軸的層次，越大代表在越上層
	parent.addChild(_touchedPic,1); // 加入目前的 Layer 中 1: Z 軸的層次，越大代表在越上層
